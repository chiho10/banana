...
install_badvpn(){
	...
	wget https://raw.githubusercontent.com/chiho10/banana/master/badvpn-1.999.128.tar.bz2
	...
	cd /usr/bin
        wget https://raw.githubusercontent.com/chiho10/banana/master/badvpn-udpgw
